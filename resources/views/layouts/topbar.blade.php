    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-none dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    ...
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <!-- ✅ Temporary Static Image (Baad mein dynamic kar lena) -->
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- ✅ Temporary Static Welcome -->
                        <h6 class="dropdown-header">Welcome Admin User!</h6>
                        
                        <!-- Baad mein yeh route('profile.index') se replace ho jayega -->
                        ...
                        <a class="dropdown-item" href="#" data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">   
